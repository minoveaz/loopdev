...
CREATE INDEX idx_strategy_organization_id ON strategy(organization_id);
...
-- Index Scan using idx_strategy_organization_id
...
**Checklist**:
- [ ] Indexes on foreign keys (organization_id, user_id, strategy_id)
