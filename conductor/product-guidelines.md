...
- **Quality Shield:** Production deployment is gated by dual certification (Frontend + Infrastructure) and automated checks (Vitest, Axe-core and static quality gates).
...
- **Architecture Decision Records (ADRs):** _Proposed Adoption:_ Formalize major architectural choices into a dedicated `docs/adr/` directory to create an immutable history of the system's design evolution.
