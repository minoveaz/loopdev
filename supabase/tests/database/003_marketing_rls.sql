...
select throws_ok($$ insert into public.marketing_campaign_records (organization_id, brand_id, workspace_id, name, objective, created_by, updated_by) values ('00000000-0000-4000-9100-000000000002', '00000000-0000-4000-9200-000000000002', '00000000-0000-4000-9300-000000000002', 'Cross tenant', 'RLS fixture', '00000000-0000-4000-8100-000000000001', '00000000-0000-4000-8100-000000000001') $$, 'owner cannot create campaign in another organization');
