...
2. **Notificación Preventiva al Capitán y Participantes:**
   - Emitir un aviso discreto en el canal: _"⏳ Este chat se archivará automáticamente en 2 horas"_.
3. **Historial de Solo Lectura:**
   - Los participantes confirmados podrán seguir consultando los mensajes y las fotos en la pestaña _Archivados_, pero el canal quedará bloqueado contra nuevos envíos.
...
2. **Banner de Recuperación:**
   - Al volver a abrir `/app/create`, si existe un borrador guardado en las últimas 24 horas, mostrar un aviso: _"Tienes un borrador pendiente de tu quedada de Running en Retiro. [Recuperar] [Descartar]"_.
3. **Limpieza tras Publicación:**
   - Al hacer clic en _Publicar Convocatoria Grupal_, el borrador se purga automáticamente de `localStorage`.
