...
export const INITIAL_ACTIVITIES: ActivityCardData[] = [
  ...
  },
  {
    ...
    instructions: 'Circuito llano y rápido cruzando hacia Casa de Campo. Imprescindible poder mantener el ritmo acordado.',
    maxMembers: 6,
    captain: {
      id: 'capt_5',
      name: 'Carlos Ruiz',
    ...
    currentMembers: [
      { id: 'capt_5', name: 'Carlos Ruiz', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400', age: 33, isCaptain: true },
      { id: 'usr_10', name: 'Sergio', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=400', age: 29 },
      { id: 'usr_11', name: 'Alba', avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=400', age: 27 },
    ],
    isJoined: false,
    thirdHalf: {
      enabled: true,
  ...
  },
  {
    ...
    currentMembers: [
      { id: 'capt_6', name: 'Lucía Morales', avatarUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=400', age: 28, isCaptain: true },
      { id: 'usr_12', name: 'Raúl', avatarUrl: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&q=80&w=400', age: 31 },
    ],
    isJoined: false,
    thirdHalf: {
      enabled: true,
  ...
  },
  {
    ...
    instructions: 'Ascensión al techo de Madrid. Cortavientos, crema solar y mínimo 2L de agua por persona.',
    maxMembers: 8,
    captain: {
      id: 'capt_7',
      name: 'Diego Navarro',
    ...
    currentMembers: [
      { id: 'capt_7', name: 'Diego Navarro', avatarUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=400', age: 35, isCaptain: true },
      { id: 'usr_13', name: 'Beatriz', avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=400', age: 30 },
      { id: 'usr_14', name: 'Gonzalo', avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400', age: 34 },
      { id: 'usr_15', name: 'Marina', avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=400', age: 28 },
    ],
    isJoined: false,
    thirdHalf: {
      enabled: true,
  ...
  },
  {
    ...
    instructions: 'Calentamiento de 2K, bloque de series en la recta de coches y estiramientos dirigidos.',
    maxMembers: 6,
    captain: {
      id: 'capt_8',
      name: 'Sofía Díaz',
    ...
    currentMembers: [
      { id: 'capt_8', name: 'Sofía Díaz', avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=400', age: 27, isCaptain: true },
      { id: 'usr_16', name: 'Javier', avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=400', age: 31 },
    ],
    isJoined: false,
    thirdHalf: {
      enabled: true,
