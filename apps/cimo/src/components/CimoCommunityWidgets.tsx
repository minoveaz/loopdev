    ...
    >
      ...
      <div className="flex flex-col gap-3">
        ...
        {joinedActivities.length === 0 ? (
          <div className="py-4 text-center text-xs text-[#1F4E5F]/50">
            No tienes entrenos confirmados. Dale a "Unirme" en el feed para reservar tu plaza.
          </div>
        ) : (
        ...
        {joinedActivities.length > 0 && (
          <button
            ...
            className="text-xs font-extrabold text-[#00B894] hover:underline flex items-center justify-center gap-1 pt-0.5 cursor-pointer"
          >
      ...
      {/* Section 2: Capitanes Destacados en Madrid */}
      <div className="flex flex-col gap-3 pt-2 border-t border-[#1F4E5F]/10">
        ...
        <div className="flex flex-col gap-2.5">
          {verifiedCaptains.map((capt) => (
            <div key={capt.id} className="flex items-center justify-between gap-2.5 p-2 rounded-xl hover:bg-[#F7F7F7] transition-colors">
      ...
      {/* Section 3: Filosofía & Garantía CIMO */}
      <div className="p-3.5 bg-[#7FB77E]/10 border border-[#7FB77E]/20 rounded-2xl text-[#1F4E5F] flex items-start gap-2.5 mt-auto">
        ...
        <div className="text-xs">
          <span className="font-extrabold block text-[11px]">Garantía CIMO</span>
          <p className="text-[10px] text-[#1F4E5F]/80 mt-0.5 leading-relaxed">
            Planes 100% deportivos en microgrupos de 4 a 6 personas. Sin citas ni swipes.
          </p>
        </div>
      </div>
    </aside>
