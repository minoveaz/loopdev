    ...
    <div className="p-4 bg-[#F7F7F7] rounded-2xl border border-[#1F4E5F]/15 flex flex-col gap-3 animate-in fade-in zoom-in-98 duration-150 text-[#1F4E5F]">
      <div className="flex items-center justify-between">
        <span className="text-xs font-black uppercase tracking-wider text-[#1F4E5F]/70 flex items-center gap-1.5">
          <Search className="w-3.5 h-3.5 text-[#00B894]" />
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-9 pr-4 py-2 bg-white rounded-xl border border-[#1F4E5F]/20 focus:border-[#00B894] focus:ring-2 focus:ring-[#00B894]/20 text-xs font-bold text-[#1F4E5F] outline-none shadow-2xs"
          autoFocus
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 max-h-56 overflow-y-auto">
            ...
            <button
              ...
              className={`p-2.5 rounded-xl text-left transition-all cursor-pointer flex items-center justify-between ${
                isSelected
                  ...
                  : 'bg-white hover:bg-[#00B894]/10 border border-[#1F4E5F]/10 text-[#1F4E5F]'
              }`}
            >
        ...
        {query.trim() && !hasExactMatch && (
          <button
            ...
            className="p-2.5 rounded-xl text-left transition-all cursor-pointer flex items-center gap-2 bg-white hover:bg-[#00B894]/10 border border-dashed border-[#00B894] text-[#1F4E5F]"
          >
            <Plus className="w-4 h-4 text-[#00B894] shrink-0" />
            <div className="truncate">
