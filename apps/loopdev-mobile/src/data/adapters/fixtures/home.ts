export type Organization = { id: string; name: string; slug?: string; memberCount: number; status: 'active' | 'paused' };
...
export const activity: ActivityItem[] = [
  { id: 'activity-1', title: 'Nueva organización conectada', detail: 'Nova Labs', age: 'Hace 12 min' },
  { id: 'activity-2', title: 'Permisos revisados', detail: 'LoopDev', age: 'Hace 48 min' },
  { id: 'activity-3', title: 'Sesión administrativa iniciada', detail: 'SuperDev', age: 'Hoy, 09:14' },
];

export const notifications: NotificationItem[] = [
  { id: 'notification-1', title: 'Revisión pendiente', detail: 'Atlas Studio necesita atención', unread: true },
  { id: 'notification-2', title: 'Sincronización completada', detail: 'Todos los servicios operativos', unread: false },
];
