  ...
  return (
    <InspectorPanel
      ...
      className={cn(
        ...
        confluence === 100 &&
          'border-l-2 border-emerald-500/50 shadow-[inset_10px_0_20px_rgba(16,185,129,0.05)]',
      )}
      footerSlot={
        <div className="flex w-full flex-col gap-4">
          <div className="flex gap-2">
            <Button
              ...
              fullWidth
              startIcon="bolt"
              className="h-14 rounded-2xl font-black uppercase tracking-[0.2em] shadow-xl shadow-rose-500/10"
            >
              PANIC_EXIT
            </Button>
            <Button
              ...
              fullWidth
              startIcon="settings"
              className="h-14 rounded-2xl border-white/10 font-black uppercase tracking-[0.2em] hover:bg-white/5"
            >
              CONFIG
            </Button>
          </div>
          <LpdText
            size="nano"
            className="text-text-muted text-center font-mono italic tracking-tighter opacity-40"
          >
