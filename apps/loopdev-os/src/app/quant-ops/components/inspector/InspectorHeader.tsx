    ...
    <section className="flex flex-col gap-4">
      <div className="flex items-start justify-between">
        <div className="flex flex-col">
          <LpdText size="xl" weight="black" className="text-text-main font-mono leading-none tracking-tighter">
            {bot.pair}
          </LpdText>
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <div className="flex items-center gap-1.5 rounded border border-white/10 bg-white/5 px-2 py-0.5">
            ...
            <LpdText size="nano" className="text-status-success font-mono opacity-80">12ms_OK</LpdText>
          </div>
        </div>
      </div>
    </section>
