  ...
  return (
    <section className="flex flex-col gap-4">
      <div className="flex items-end justify-between px-1">
        <LpdText size="nano" weight="black" className="text-text-muted uppercase tracking-[0.2em] opacity-40">Entry_Watch_Protocol</LpdText>
        <div className="flex flex-col items-end gap-1.5">
          <LpdText size="nano" className="text-primary font-mono text-[8px] uppercase opacity-60">Next_Evaluation</LpdText>
          <div className="flex items-center gap-3">
            ...
            <div className="h-1 w-16 overflow-hidden rounded-full bg-white/5">
              <div className="bg-primary h-full transition-all duration-1000 ease-linear" style={{ width: `${(secondsLeft/600)*100}%` }} />
            </div>
          </div>
        </div>
      </div>

      <TechnicalSurface variant="surface" className="border-border-technical/40 space-y-6 rounded-3xl border bg-slate-950/60 p-6 shadow-2xl">
        ...
        <div className="space-y-4 pt-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <LpdText size="xs" weight="bold" className="text-text-main">Regime: <span className="text-primary uppercase">{bot.macroSentiment}</span></LpdText>
            </div>
            {!isBullish && <LpdText size="nano" className="font-black uppercase italic tracking-widest text-rose-500">[ABORT_LONG]</LpdText>}
          </div>
          <div className="flex items-center gap-3">
