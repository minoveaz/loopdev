...
import { StatsCards, OrdersTable, ClosedTradesTable, OrderFilters } from './components';
    ...
    <main className="animate-in fade-in custom-scrollbar mx-auto flex h-full max-w-[1600px] flex-col gap-8 overflow-y-auto p-8 pb-32 duration-700">
      ...
      <header className="flex flex-col gap-2">
        ...
        <LpdText size="sm" className="text-text-muted max-w-2xl leading-relaxed">
          Comprehensive audit trail of every closed position and executed order. Real-time
          statistics and detailed trade analysis.
        </LpdText>
      </header>
