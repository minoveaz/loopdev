...
export const PipelineFilters: React.FC<PipelineFiltersProps> = ({
  ...
  return (
    <TechnicalSurface
      ...
      depth="flat"
      overflow="visible"
      className="px-3 sm:px-6 py-4 border border-border-technical/60 rounded-3xl shadow-sm bg-shell-surface/60 backdrop-blur-md shrink-0 relative z-30 overflow-x-auto"
    >
        ...
        <div className="flex-1 min-w-0">
          <FilterDropdown
            ...
            label={
              timeFilter === 'all'
                ? 'Todos'
                : ({ '7d': 'Últimos 7 días', '14d': 'Últimos 14 días', '30d': 'Último mes' }[
                    timeFilter
                  ] ?? 'Todos')
            }
          ...
          {labelFilter.map((l) => (
            ...
            >
              ...
              <IconButton
                ...
                className="hover:text-energy-yellow/70 cursor-pointer"
              />
            </span>
          ))}
        </div>
