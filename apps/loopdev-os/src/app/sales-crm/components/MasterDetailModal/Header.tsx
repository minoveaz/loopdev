      ...
      <div className="p-5 flex flex-col gap-4">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-grow min-w-0">
            <h2 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white truncate">{editedLead.name}</h2>
        ...
        >
          ...
          >
            <svg className={`w-4 h-4 shrink-0 ${activeCreator === 'call' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button 
            ...
            title="Nueva Tarea"
          >
            <svg className={`w-4 h-4 shrink-0 ${activeCreator === 'task' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button 
            ...
            title="Tomar Nota"
          >
            <svg className={`w-4 h-4 shrink-0 ${activeCreator === 'note' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <svg className={`w-4 h-4 shrink-0 ${activeCreator === 'email' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
