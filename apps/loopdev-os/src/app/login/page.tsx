          ...
          <div className="mb-10 space-y-4 text-center">
            ...
            <div className="space-y-1">
              <Heading
                size="2xl"
                weight="bold"
                className="flex items-center justify-center gap-1 tracking-tighter text-white"
              >
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <LpdText
                ...
                size="nano"
                weight="black"
                className="text-primary/60 hover:text-primary absolute right-0 top-0 z-20 flex h-6 cursor-pointer items-center pr-1 uppercase tracking-widest transition-colors"
              >
                Recuperar
              </LpdText>{' '}
            </div>
