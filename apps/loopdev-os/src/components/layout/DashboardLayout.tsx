      ...
      <header className="glass-panel relative z-20 flex shrink-0 items-center justify-between border-b border-white/5 px-8 py-4">
        ...
        <div className="flex items-center gap-6">
          <nav className="hidden items-center gap-6 text-sm font-medium text-slate-400 md:flex">
            <a href="#" className="transition-colors hover:text-white">Workspace</a>
            <a href="#" className="transition-colors hover:text-white">Resources</a>
            <a href="#" className="transition-colors hover:text-white">Analytics</a>
          </nav>
      ...
      <div className="flex flex-1 flex-col gap-6 overflow-hidden p-6 md:flex-row">
        ...
        <aside className="flex w-full flex-col gap-6 md:w-64">
          <div className="glass-panel rounded-xl border border-white/5 p-6">
            <Heading as="h3" size="xs" weight="bold" className="mb-4 uppercase tracking-widest text-slate-500">Core Stats</Heading>
          ...
          <div className="glass-panel flex-1 rounded-xl border border-white/5 p-6">
            <Heading as="h3" size="xs" weight="bold" className="mb-4 uppercase tracking-widest text-slate-500">Live Activity</Heading>
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
