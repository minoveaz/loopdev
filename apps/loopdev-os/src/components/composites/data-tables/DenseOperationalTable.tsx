...
const defaultRows: DenseOperationalRow[] = [
  ...
  },
  {
    ...
    status: 'Paused',
    owner: 'Diego',
    email: 'team@pine.example',
    region: 'Europe',
    updated: 'Aug 12, 10:04',
  },
  {
    id: 'summit',
    name: 'Summit Works',
...
const defaultColumns: ResponsiveTableColumn<DenseOperationalRow>[] = [
  ...
  },
  {
    ...
    header: 'Email',
    sortable: true,
    className: 'max-w-56 text-sm text-text-muted',
    render: (row) => (
...
export type DenseOperationalTableProps = Omit<
  ResponsiveTableProps<DenseOperationalRow>,
  'rows' | 'columns' | 'getRowKey' | 'caption'
> & {
