...
describe('MetricGauge Component', () => {
  ...
  it('supports different size variants', () => {
    const { container: containerSm } = render(
      <MetricGauge value={50} size="sm" label="RSI" />
    );
    const { container: containerLg } = render(
      <MetricGauge value={50} size="lg" label="RSI" />
    );
  ...
  it('applies custom className', () => {
    const { container } = render(
      <MetricGauge value={50} className="custom-class" label="RSI" />
    );
