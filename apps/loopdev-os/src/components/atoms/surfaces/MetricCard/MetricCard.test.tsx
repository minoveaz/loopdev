...
describe('MetricCard Component', () => {
  ...
  it('displays description when provided', () => {
    render(
      <MetricCard 
        label="ATR" 
        value={36.146} 
        description="36 pips volatility"
      />
    );
  ...
  it('shows direction indicator when direction is provided', () => {
    const { rerender } = render(
      <MetricCard label="Price" value={71000} direction="up" />
    );
  ...
  it('handles numeric and string values', () => {
    const { rerender } = render(
      <MetricCard label="Price" value={71000.45} />
    );
  ...
  it('supports different size variants', () => {
    const { container: smContainer } = render(
      <MetricCard label="Test" value={1} size="sm" />
    );
    const { container: mdContainer } = render(
      <MetricCard label="Test" value={1} size="md" />
    );
    const { container: lgContainer } = render(
      <MetricCard label="Test" value={1} size="lg" />
    );
  ...
  it('handles large and small numbers correctly', () => {
    const { rerender } = render(
      <MetricCard label="Test" value={1000000.999} />
    );
