    ...
    return (
      <div className="animate-in slide-in-from-right-4 flex flex-col gap-8 duration-300">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="border-border-technical flex flex-col gap-4 rounded-xl border p-4" style={{ backgroundColor: baseline }}>
  ...
  return (
    <div className="animate-in slide-in-from-right-4 flex flex-col gap-6 duration-300">
      <div className="flex flex-col gap-1">
        ...
        <LpdText size="sm" weight="bold" className="text-primary font-mono">{token.id}</LpdText>
      </div>
      <div className="flex flex-col gap-1">
      ...
      <div className="grid grid-cols-2 gap-4 pt-4">
        <div className="border-border-technical bg-background-subtle rounded-xl border p-3">
          <LpdText size="nano" className="text-text-muted mb-1 uppercase">Light Val</LpdText>
          <LpdText size="xs" weight="bold" className="font-mono">{token.resolvesTo.light}</LpdText>
        </div>
        <div className="border-border-technical bg-background-subtle rounded-xl border p-3">
          <LpdText size="nano" className="text-text-muted mb-1 uppercase">Dark Val</LpdText>
