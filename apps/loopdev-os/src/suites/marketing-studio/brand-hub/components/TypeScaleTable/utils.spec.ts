...
describe('TypeScaleTable Logic', () => {
  ...
  it('should calculate base size correctly (power 0)', () => {
    // 16 * 1.25^0 = 16
  ...
  it('should calculate scale up correctly (power 2)', () => {
  ...
  it('should calculate scale down correctly (power -1)', () => {
  ...
  it('should handle custom base sizes', () => {
    // 14 * 1.2^1 = 16.8 -> 17
