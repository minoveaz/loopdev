      ...
      <TechnicalCard variant="flat" className="p-5 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2 max-h-[160px] overflow-y-auto custom-scrollbar text-[11px] text-text-muted font-mono select-none">
          {lead.history?.map((h, idx) => (
            <div
              key={idx}
              className="flex justify-between border-b border-slate-100 dark:border-white/5 pb-1"
            >
              <span>{h.action}</span>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1 px-1 text-[10px]">
                      <div className="flex min-w-0 items-center gap-2">
                        <LpdText
                          size="nano"
                          weight="bold"
                          className="text-text-main dark:text-white font-sans"
                        >
                          {entry.actor}
                        </LpdText>
                        {entry.category && (
        ...
        <div className="flex flex-col gap-4 animate-in fade-in duration-200">
          ...
          <div className="flex flex-col gap-2.5">
            <LpdText
              ...
              weight="black"
              variant="mono"
              className="text-text-muted dark:text-slate-400 uppercase tracking-widest select-none"
            >
              ...
              <div className="flex flex-col gap-2.5">
                {lead.documents.map((doc) => (
                  <TechnicalCard
                    key={doc.id}
                    variant="flat"
                    className="p-3.5 flex items-center justify-between font-sans"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <LpdText
                          size="xs"
                          weight="bold"
                          className="text-text-main dark:text-white truncate max-w-[220px]"
                        >
                          {doc.name}
                        </LpdText>
