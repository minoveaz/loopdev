...
| `pnpm quality:static:worktree`             | Fast local static feedback                                                       | Runs Prettier and ESLint only for changed worktree files; it does not run repository-wide scans            |
| `pnpm quality:static:commit`               | Static feedback for one commit                                                   | Runs Prettier and ESLint for that commit's files; it does not run repository-wide scans                    |
| `pnpm quality:static:branch`               | Branch or CI static certification                                                | Adds classes, contract ownership, source contracts, frontend audit, duplication, and Knip scans            |
