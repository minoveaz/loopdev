...
export const CrmContactSchema = z.object({
  ...
  secondaryPhone: z.string().trim().min(3).max(32).nullable().optional(),
  preferredChannel: z.enum(['whatsapp', 'phone', 'email']).nullable().optional(),
...
export const CrmCreateContactCommandSchema = z
  .object({
    ...
    secondaryEmail: NullableEmailSchema,
    phone: NullablePhoneSchema,
    secondaryPhone: NullablePhoneSchema,
    preferredChannel: z.enum(['whatsapp', 'phone', 'email']).nullable().optional(),
    preferredLanguage: z.string().trim().max(10).nullable().optional(),
    documentType: z.string().trim().max(40).nullable().optional(),
    documentNumber: z.string().trim().max(60).nullable().optional(),
...
export const CrmLeadSchema = z.object({
  ...
  purchaseTimeline: z.string().trim().max(80).nullable().optional(),
  leadScore: z.coerce.number().int().min(0).max(100).nullable().optional(),
