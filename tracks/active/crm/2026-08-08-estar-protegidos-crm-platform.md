...
blocked_by: []
supersedes: []
migration_source: conductor/tracks/2026-08-08-estar-protegidos-crm-platform.md
lead: null
branches: [feature/crm-core-fase-6a]
phase: 6
pull_requests: []
issues: []
packages: []
...
# CRM multi-tenant y comunicaciones de Estar Protegidos
...
Este programa se entrega por fases integradas y ramas especializadas. La evidencia de CRM Core,
captación y comunicaciones ya está integrada mediante los PRs `#27` y `#31`; las ramas activas de
las siguientes fases se declaran en `branches` y en su fase antes de iniciar implementación.
...
- Reclasificado como `active` tras revisar los commits `5d71ac9` y `3cad9da`, que implementan CRM
  Core, APIs, captación y persistencia de comunicaciones.
