...
3. **CIMO App (`cimo.app`):** Red social deportiva, feed de planes en 3 columnas, microgrupos (*Crews*), chat y comunidad PWA.
4. **Cualquier Cliente Futuro:** Capacidad de lanzar nuevas webs públicas o portales en minutos componiendo bloques reutilizables e inyectando tokens de marca (*White-Label Theming*).
