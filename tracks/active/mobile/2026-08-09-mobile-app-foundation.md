...
La fundación móvil es un programa transversal. No hay una rama única vigente; cada fase debe declarar su rama de implementación antes de iniciar cambios de código.
