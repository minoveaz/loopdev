    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col min-w-0">
            <LpdText size="xs" weight="black" className="uppercase tracking-[0.2em] text-text-muted opacity-60 leading-none">Status</LpdText>
            <LpdText size="sm" weight="black" className="uppercase tracking-tighter text-text-main mt-2">{displayAction}</LpdText>
          </div>
        </div>
        
        {isActive && (
          <NextEvalTimer lastUpdatedAt={bot.updatedAt} className="self-start" />
        )}
      </div>
      ...
      <div className="flex items-center justify-between px-1 border-b border-white/5 pb-4">
        <div className="flex flex-col gap-1">
          <LpdText size="nano" weight="black" className="text-text-muted opacity-40 italic uppercase tracking-widest leading-none">Session_Scoreboard:</LpdText>
      ...
      {bot.logicSnapshot?.trigger_price && (
        <div className="flex flex-col gap-2 p-4 bg-white/5 rounded-2xl border border-white/5">
          <div className="flex items-center justify-between">
            <LpdText size="nano" weight="black" className="text-text-muted opacity-40 uppercase tracking-widest">Distance_To_Trigger</LpdText>
            <LpdText size="nano" className="text-primary font-mono">ESTIMATED</LpdText>
          </div>
          ...
          <div className="flex items-baseline justify-between">
            ...
            <div className="flex flex-col items-end">
              <LpdText size="nano" className="text-text-muted opacity-40 uppercase font-bold">Target_Price</LpdText>
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        <div className="flex flex-col gap-1 p-2 rounded-xl bg-white/[0.03] border border-white/5">
          <LpdText size="nano" weight="black" className="text-text-muted opacity-40 uppercase tracking-tighter">
        ...
        <div className="flex flex-col gap-1 p-2 rounded-xl bg-white/[0.03] border border-white/5">
          <LpdText size="nano" weight="black" className="text-text-muted opacity-40 uppercase tracking-tighter">BIAS</LpdText>
