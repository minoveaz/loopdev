...
export const TopBar: React.FC<TopBarProps> & {
  ...
  const headerStyle = data.settings.layout.headerStyle;
  const isBrandStyle = headerStyle === 'brand';

  // Wrapper for common styles
  const TopBarWrapper = ({ children: wrapperChildren, className: wrapperClassName }: { children: React.ReactNode; className?: string }) => (
